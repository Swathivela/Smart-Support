...
public class ScanToSpeak extends AppCompatActivity  implements TextToSpeech.OnInitListener {
    ...
    private void texttoSpeak() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("spf", Context.MODE_PRIVATE);
   ...
   /* public void onBackPressed() {
        ...
        textToSpeech.speak("Do you Bookmark this page ? yes? , no?", TextToSpeech.QUEUE_FLUSH, null);
        // Set Alert Title
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode){
            case 10:
                if(resultCode==RESULT_OK && data!=null){
                    ArrayList<String> result=data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                    detectedText.setText(result.get(0));
                    detectedText=result.get(0);
                }
                break;
        }
